...
public class HistoryCursorAdapter extends CursorAdapter {
    ...
    /**
     * Constructs a new {@link HistoryCursorAdapter}.
     *
    ...
    /**
     * This method binds the supplement data (in the current row pointed to by cursor) to the given
     * list item layout. For example, the name for the current supplement can be set on the name TextView
